...
I used to bootstrap grid  to make a custom heading. I placed the h2 and first cat image in a div with the class row and then put them both in to div's with bootstrap grid column. `col-xs-*` column-Extra Small- num between 1 to 12.
