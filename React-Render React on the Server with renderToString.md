...
This was similar to passing a component to the render method. I just had to write`ReactDOMServer.renderToString() ` and then place the components name in a self closing tag inside the parentheses.
