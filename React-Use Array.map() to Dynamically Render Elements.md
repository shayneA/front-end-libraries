...
First, I initialized the state with userInput and toDoList, one set to empty sting and the other to an empty array. 

Next, I used `Array.map()` to map out the array and surround the inputted text in li tags. 
