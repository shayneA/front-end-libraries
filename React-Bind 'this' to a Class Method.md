...
First I blinded this to handleClick by adding ` this.handleClick = this.handleClick.bind(this)` above the render part in my component. Next I linked the button to handleClick by adding the prop `<button onClick={this.handleClick}>Click Me</button>` in the button tag the rest was done for me. 
