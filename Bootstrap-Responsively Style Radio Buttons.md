...
First I placed the 2 radio buttons in a div and gave it a class row. Then I placed each indivisual button in its own div and gave it the class `col-xs-6`.
