...
I used the ternary operator to check if the user inputted more than 15 characters and if they did I changed the style for the input box to`border: 3px solid red`. This is a good example of using a components state to change the style of my page. 
