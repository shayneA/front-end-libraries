...
I used the connect method to link the Presentational component to Redux I assigned the value to a const called Container. Then I rendered this Container component as a child inside the AppWrapper. I wrapped the Container in the Provider component. 
