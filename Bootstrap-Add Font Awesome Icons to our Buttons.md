...
I placed the i element inside of the like button. 
...
Alternative solution using span instead of i.  

`````html
<button class="btn btn-block btn-primary">Like <span class="fas fa-thumbs-up"></span></button>
`````
