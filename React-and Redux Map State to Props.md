...
I created a function called mapStateToProps which takes `state` as an argument and it returns an object with a property messages and a value of the state. 
